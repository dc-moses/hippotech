...
public class ApprovalRequest {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(propertyPostCode, propertyValue, amountToBorrow, about, firstName, lastName, nationalInsuranceNumber, country, streetAddress, city, postCode, approvalNotifications, changeNotifications, offerNotifications, pushNotifications);
    }
